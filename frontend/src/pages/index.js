			...
			<Box display="grid" grid-template-columns="repeat(3, 1fr)" grid-gap="32px 4%" md-grid-template-columns="1fr">
				...
				>
					<Icon
						...
						size="48px"
					/>
					<Text margin="0px 0px 18px 0px" color="#1A1B41" font="--headline3" lg-text-align="left">
						No delays
					</Text>
					<Text
						margin="0px 0px 0px 0px"
						...
						flex="1 0 auto"
					>
						Have virtually no delay in your production line using our 2 minutes one-time setup workflow.
					</Text>
				</Box>
				<Box
					padding="45px 45px"
				...
				>
					...
					<Text
						...
						flex="1 0 auto"
					>
						With flexible payment options, you only pay for what you print. No hidden charges. Ever.
					</Text>
				</Box>
				<Box
					padding="45px 45px"
				...
				>
					...
					<Text
						...
						flex="1 0 auto"
					>
						AuthGen's Invisible QR code allows the end-users and customers the power to validate the products themselves.{" "}
					</Text>
				</Box>
			</Box>
		</Section>
		<Section padding="80px 0 80px 0" sm-padding="60px 0 60px 0" background="#EDF2F6">
			...
			>
				...
				>
					...
					<Box>
						...
						<Text margin="0px 0px 0px 0px" color="--greyD3" font="--base" lg-text-align="left">
							After Login, all you have to do is to upload the product label, which will then be processed in our servers.
						</Text>
					</Box>
				</Box>
				<Box
				...
				>
					...
					<Box>
						...
						<Text margin="0px 0px 0px 0px" color="--greyD3" font="--base" lg-text-align="left">
							Download the encoded product label, print it and use it as usual.{" "}
						</Text>
					</Box>
				</Box>
				<Box
				...
				>
					...
					<Box>
						...
						<Text margin="0px 0px 0px 0px" color="--greyD3" font="--base" lg-text-align="left">
							Take a clear picture of your product label and scan it using our decoder. Our job is to tell you whether it is authentic or not.
						</Text>
					</Box>
				</Box>
			</Box>
				...
				>
					<Box min-width="100px" min-height="100px">
						<Text margin="0px 0px 25px 0px" font="normal 300 16px/1.5 --fontFamily-sans" color="#505257">
							Steganography, the art of hiding information within seemingly innocuous data, has evolved significantly with technological advancements. We developed a unique approach here at AuthGen that generates invisible QR codes. This innovative process combines BCH codes for error correction, Generative Adversarial Networks (GANs), and Discrete Cosine Transform (DCT) steganography to create visually imperceptible yet robust hidden messages.
						</Text>
